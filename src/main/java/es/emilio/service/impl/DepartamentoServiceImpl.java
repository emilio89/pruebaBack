...
public class DepartamentoServiceImpl implements DepartamentoService {
     ...
     * @return the list of entities.
     */
    public Page<Departamento> findAllWithEagerRelationships(Pageable pageable) {
        return departamentoRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Departamento> findOne(Long id) {
        ...
        return departamentoRepository.findOneWithEagerRelationships(id);
    }
