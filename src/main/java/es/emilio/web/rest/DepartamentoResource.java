...
/**
 * REST controller for managing {@link es.emilio.domain.Departamento}.
 */
@RestController
@RequestMapping("/api")
public class DepartamentoResource {
    ...
    public ResponseEntity<List<Departamento>> getAllDepartamentos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
